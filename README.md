...
![Python](https://skillicons.dev/icons?i=js,html,css,cpp,nodejs,java,py,mysql,php,apache,vscode,clion)<img src="logo.png" width="100" height="100" alt="Gundam OverBoost Icon"/>
